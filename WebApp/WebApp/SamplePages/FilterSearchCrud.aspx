...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-offset-1">
       ...
       <asp:DropDownList ID="EditAlbumArtistList" runat="server" DataSourceID="EditArtistListODS" DataTextField="Name" DataValueField="ArtistId"></asp:DropDownList>
        ...
        <asp:LinkButton ID="Remove" runat="server" CausesValidation="false" OnClick="Remove_Click" OnClientClick="return confirm('Are you sure to remove this album?')">Remove</asp:LinkButton>
    </div>
